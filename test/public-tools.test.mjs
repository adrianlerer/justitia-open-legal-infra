...
import { morphLegalParagraph } from '../src/iusmorfos.mjs';
...
test('Iusmorfos separates norm, inference and strategy', () => {
  const moves = morphLegalParagraph('El art. 1 de la ley establece el deber. En consecuencia, hay riesgo. Conviene mitigar.');
